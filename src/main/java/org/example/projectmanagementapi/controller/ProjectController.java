...
public class ProjectController {
    ...
    public ResponseEntity<?> addProjectMember(@PathVariable Integer projectId, @PathVariable Integer userId) {
        projectService.addProjectMember(projectId, userId);
        return new ResponseEntity<>(HttpStatus.OK);
    }

    @DeleteMapping("/{projectId}/members/{userId}")
    public ResponseEntity<?> removeProjectMember(@PathVariable Integer projectId, @PathVariable Integer userId) {
