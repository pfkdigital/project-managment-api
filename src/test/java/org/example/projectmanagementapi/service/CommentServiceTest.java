...
class CommentServiceTest {
    ...
    void createComment_createsAndReturnsComment() {
        CommentDto commentDto = CommentDto.builder().content("Content").authorId(1).issueId(1).taskId(1).build();
    ...
    void getComments_returnsAllComments() {
        List<Comment> comments = List.of(Comment.builder().id(1).content("Content1").build(), Comment.builder().id(2).content("Content2").build());
